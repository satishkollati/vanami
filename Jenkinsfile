pipeline{
    ...
    stages{
        ...
        stage("deployment"){
            steps{
                ansiblePlaybook credentialsId: 'ansible-user', disableHostKeyChecking: true, extras: "-e ${env.BUILD_ID}", installation: 'ansible', inventory: 'inventary', playbook: 'ansible-deploy.yml', sudo: true            }
        }
