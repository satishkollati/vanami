pipeline{
    ...
    stages{
        ...
        stage("deployment"){
            steps{
                ansiblePlaybook credentialsId: 'ansible-user3', disableHostKeyChecking: true, extras: "-e ${DOCKER_TAG}", installation: 'ansible', inventory: 'inventary', playbook: 'ansible-deploy'
                         }
        }
